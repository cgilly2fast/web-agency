...
import { CollectionConfig, CollectionSlug, DataFromCollectionSlug, TypeWithID } from 'payload'
...
export type UploadPathFunc = (path: string) => Promise<DataFromCollectionSlug<CollectionSlug>>
